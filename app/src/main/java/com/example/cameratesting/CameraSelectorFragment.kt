...
import com.example.cameratesting.adapter.GenericListAdapter

class CameraSelectorFragment : Fragment() {
            ...
            adapter = GenericListAdapter(cameraList, itemLayoutId = layoutId) { view, item, _ ->
                ...
                view.setOnClickListener {
                    Navigation.findNavController(requireActivity(), R.id.fragment_container)
                        .navigate(
                            CameraSelectorFragmentDirections.actionSelectorToCamera(
                                item.cameraId,
                                item.format
                            )
                        )
